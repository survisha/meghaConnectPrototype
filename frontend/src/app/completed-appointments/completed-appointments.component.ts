...
export class CompletedAppointmentsComponent implements OnInit,OnDestroy {
  ...
  constructor(public readonly reports:ExecutiveAppointmentReportService,private readonly documents:DocumentService,private readonly toast:ToastService,private readonly dialog:MatDialog){}
  ngOnInit(){this.load();}
